...
const generateAccessToken =  (userInfo)=>{
  const signedAccessToken =  jwt.sign(userInfo, process.env.ACCESS_TOKEN_SECRET, {expiresIn: '1h'});
  redisClient.setEx(
...
const generateRefreshToken = (userInfo)=>{
  const signedRefreshToken = jwt.sign(userInfo, process.env.REFRESH_TOKEN_SECRET)
