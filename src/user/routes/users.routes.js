...
import { userRegister, userLogin, userHome, userLogout, userGenerateToken, userSaveUser, userProfilePic } from '../controllers/users.controller.js';
import{ authenticateAccessToken, authenticateRefreshToken } from '../middlewares/authenticateToken.middleware.js'
import {registerValidator , loginValidator } from '../middlewares/joiValidation.middleware.js';
...
usersRouter.post('/registration-generate-otp', registerOtpValidation ,userSaveUser); 
